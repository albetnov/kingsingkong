...
<head>
  ...
  <!-- Website Title -->
  <title>KingSingkong | Rajanya Singkong</title>
...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="row">
          <div class="col-lg-6 col-xl-5">
            <div class="text-container">
              ...
              <a class="btn-solid-lg page-scroll" href="#features">DISINI</a>
            </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="text-container">
            ...
            <a class="btn-solid-reg page-scroll" href="#pesan">Beli Sekarang!</a>
          </div>
          <!-- end of text-container -->
        </div>
        <!-- end of col -->
  ...
  <svg class="footer-frame" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 1920 79">
    ...
    <path class="footer-path" d="M0,72.427C143,12.138,255.5,4.577,328.644,7.943c147.721,6.8,183.881,60.242,320.83,53.737,143-6.793,167.826-68.128,293-60.9,109.095,6.3,115.68,54.364,225.251,57.319,113.58,3.064,138.8-47.711,251.189-41.8,104.012,5.474,109.713,50.4,197.369,46.572,89.549-3.91,124.375-52.563,227.622-50.155A338.646,338.646,0,0,1,1920,23.467V79.75H0V72.427Z" transform="translate(0 -0.188)" />
  </svg>
  <div class="footer">
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <div class="footer-col first">
            <h4>Tentang KingSingkong</h4>
            <p class="p-small">
              KingSingkong adalah produk Keripik Singkong Buatan Pelajar SMK
            </p>
          </div>
        </div>
        <!-- end of col -->
          ...
          <div class="footer-col middle">
            ...
            <ul class="list-unstyled li-space-lg p-small">
              <li class="media">
                <i class="fas fa-square"></i>
                <div class="media-body">
                  <a class="white" href="#">Aturan Pembelian</a>
                </div>
              </li>
              <li class="media">
                <i class="fas fa-square"></i>
                <div class="media-body">
                  Baca Juga
                  <a class="white" href="terms-conditions.html">Informasi Pemakaian</a>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div class="footer-col last">
            ...
            <ul class="list-unstyled li-space-lg p-small">
              ...
              <li class="media">
                ...
                <div class="media-body">
                  <a class="white" href="mailto:contact@tivo.com">kingsingkong-adm@gmail.com</a>
                  <br>
                  <i class="fas fa-globe"></i><a class="white" href="#">www.kingsingkong.herokuapp.com</a>
                </div>
              </li>
            </ul>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p class="p-small">
            Copyright © 2021
            <a href="https://inovatik.com">Based from Inovatik</a><br />
            Team KingSingkong
          </p>
        </div>
        <!-- end of col -->
